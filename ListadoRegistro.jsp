<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <head>
            ...
            <title>Titulación - Tramites Registrados</title>
        </head>
            ...
            <section id="inicio" class="text-dark text-center">
                ...
                <div class="container">
                    <div class="container justify-content-center">
                        <center>
                            <h1 class="text-center"> Detalles del Tramite Consultado </h1>
                        </center>
                    </div>
                </div>
                <br>
                    ...
                    <div class="card-body table-responsive">
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <c:forEach var="persona" items="${personas}">
                                    <tr>
                                        <td>${persona.registro.folio}</td>
                                        <td>${persona.nombre}</td>
                                        <td>${persona.registro.estadoRegistro}</td>
                                        <td>${persona.registro.observaciones}</td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
