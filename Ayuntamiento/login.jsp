<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <title>Titulación - Inicio de Sesión</title>
                ...
                <div class="align-items-center justify-content-between">
                    <div style="text-align:left">
                        ...
                        <div class="form-group">
                            <center>
                                <b>
                                    <h1 class="login-box-msg text-center"> Iniciar Sesión </h1>
                                </b>
                                <br>
                                <form method="post">
                                    <div style="text-align:left" id="labelname">
                                        <label class="small mb-1" for="usuario"><span
                                                style="font-size: 25px; font-weight: bold; color: rgb(0, 0, 0);">Usuario:
                                            </span></label>
                                        <input class="form-control" type="text" name="usuario" id="usuario" required>
                                        <small class="form-text text-muted"> Nunca compartas tu usuario con nadie, es
                                            personal e intransferible.</small>
                                    </div>
                                    <br>
                                    <div style="text-align:left" id="labelpassword">
                                        <label class="small mb-1" for="password"> <span
                                                style="font-size: 25px; font-weight: bold; color: rgb(0, 0, 0);">Contraseña:
                                            </span></label>
                                        <input class="form-control" type="password" name="password" id="password"
                                            minlength="8" maxlength="16" pattern="[A-Za-z0-9\W]+" required>
                                        <small class="form-text text-muted">Recuerda: Tu contraseña cuenta con por lo
                                            menos una Mayuscula, un Número y un Carácter especial.</small>
                                    </div>
                                    <br>
                                    <input class="btn btn-dark btn-block" type="submit" id="enviar"
                                        value="Iniciar sesión">
                                    <input class="btn btn-dark btn-block" style="background-color: rgb(123, 38, 47);"
                                        type="submit" id="recuperar" value="Recuperar Contraseña">
                                </form>
                            </center>
                        </div>
                    </div>
