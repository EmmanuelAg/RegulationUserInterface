                ...
                <div class="align-items-center justify-content-between">
                    <div style="text-align:left">
                        <div class="form-group">
                            <b>
                                <h1 class="login-box-msg text-left"> Buscador de Folio </h1>
                            </b>
                            ...
                            <form method="post">
                                <div style="text-align:left" id="labelname">
                                    <label class="small mb-1" for="Folio"><span
                                            style="font-size: 25px; font-weight: bold; color: rgb(0, 0, 0);">Folio del
                                            Tramite:
                                        </span></label>
                                    <input class="form-control" placeholder="Folio" name="folio" type="text" id="folio"
                                        pattern="[A-Za-z0-9]{1,}" required>
                                    <small class="form-text text-muted"> Recuerda que el Folio es Alfanumérico y no
                                        admite Espacios.</small>
                                </div>
                                <br>
