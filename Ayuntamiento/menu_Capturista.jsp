    ...
    <nav class="py-2 text-white" style="background-color: rgb(123, 38, 47)">
      <div class="container d-flex justify-content-around">
        ...
        <div class="justify-content-center">
          <br />
          <a href="index.jsp" class="btn btn-lg btn-outline-light">Cerrar Sesión</a>
        </div>
      </div>
    </nav>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container d-flex justify-content-around">
        ...
        <div class="collapse navbar-collapse">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link" href="#">Captura de Datos </a>
            </li>
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="#">Fase / Etapa</a></li>
                <li>
                  <a class="dropdown-item" href="#">Busqueda por Nombre</a>
                </li>
                <li><a class="dropdown-item" href="#">Edición de Datos</a></li>
              </ul>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown"
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li>
                  <a class="dropdown-item" href="#">Certificación Municipal</a>
                </li>
                <li>
                  <a class="dropdown-item" href="#">Aviso de Transmisiones Patromoniales</a>
                </li>
                <li>
                  <a class="dropdown-item" href="#">Inscripción de Resolución</a>
                </li>
                <li>
        ...
        <div class="d-sm-flex align-items-left justify-content-between">
          <form class="form-inline my-2 my-lg-0" id="buscarFolio">
            <input class="form-control mr-sm-2" type="search" placeholder="Buscar Folio" aria-label="Search" />
          </form>
          &nbsp; &nbsp; &nbsp;
